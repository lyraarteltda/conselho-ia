...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'conselho-ia_apikey_';
  ...
  const ENABLED_SERVICES = ['openrouter']; // OpenRouter = one key reaches every model in the picker
  ...
  // Refreshed from the LIVE OpenRouter ranking on 2026-07-27 (Rule #19 / COR).
  const AI_MODELS = {
    claude: {
      label: 'Claude (Anthropic)',
      models: [
        { id: 'anthropic/claude-sonnet-5', name: 'Claude Sonnet 5 — recomendado' },
        { id: 'anthropic/claude-opus-5', name: 'Claude Opus 5 — máximo' },
        { id: 'anthropic/claude-opus-5-fast', name: 'Claude Opus 5 (rápido)' },
        { id: 'anthropic/claude-haiku-4.5', name: 'Claude Haiku 4.5 — econômico' }
      ]
    },
    openai: {
      label: 'OpenAI',
      models: [
        { id: 'openai/gpt-5.6-sol', name: 'GPT-5.6 Sol — mais novo' },
        { id: 'openai/gpt-5.1', name: 'GPT-5.1' },
        { id: 'openai/gpt-5.1-chat', name: 'GPT-5.1 Chat' },
        { id: 'openai/gpt-5-mini', name: 'GPT-5 Mini — econômico' }
      ]
    },
    google: {
      label: 'Google (Gemini)',
      models: [
        ...
        { id: 'google/gemini-3.5-flash-lite', name: 'Gemini 3.5 Flash Lite — econômico' }
      ]
    },
    deepseek: {
      label: 'DeepSeek',
    ...
    trending: {
      ...
      // Live OpenRouter ranking snapshot 2026-07-27.
      models: [
    ...
    free: {
      label: 'Grátis (sem créditos — mais lento)',
      // Free OpenRouter models — no credits needed (rate-limited). Verified 2026-07-27.
      // Great for trying the tool without paying; premium models above are stronger.
      models: [
